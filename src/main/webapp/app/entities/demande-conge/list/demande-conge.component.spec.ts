...
describe('DemandeConge Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'demande-conge', component: DemandeCongeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to demandeCongeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDemandeCongeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDemandeCongeIdentifier).toHaveBeenCalledWith(entity);
