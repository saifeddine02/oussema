      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            paysProjet: expect.any(Object),
            regionProjet: expect.any(Object),
            dateDebut: expect.any(Object),
            nombreRessource: expect.any(Object),
            dateFin: expect.any(Object),
            competanceDemander: expect.any(Object),
            projectMenbers: expect.any(Object),
          })
        );
      });
