...
type RestOf<T extends IDemande | NewDemande> = Omit<T, 'startDemande' | 'endDemande' | 'statusDemande'> & {
...
export class DemandeService {
  ...
  protected convertDateFromClient<T extends IDemande | NewDemande | PartialUpdateDemande>(demande: T): RestOf<T> {
    return {
      ...demande,
      startDemande: demande.startDemande?.toJSON() ?? null,
      endDemande: demande.endDemande?.toJSON() ?? null,
      statusDemande: demande.statusDemande?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restDemande: RestDemande): IDemande {
    return {
      ...restDemande,
      startDemande: restDemande.startDemande ? dayjs(restDemande.startDemande) : undefined,
      endDemande: restDemande.endDemande ? dayjs(restDemande.endDemande) : undefined,
      statusDemande: restDemande.statusDemande ? dayjs(restDemande.statusDemande) : undefined,
    };
  }
