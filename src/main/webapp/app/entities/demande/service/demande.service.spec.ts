...
const requireRestSample: RestDemande = {
  ...
  startDemande: sampleWithRequiredData.startDemande?.toJSON(),
  endDemande: sampleWithRequiredData.endDemande?.toJSON(),
  statusDemande: sampleWithRequiredData.statusDemande?.toJSON(),
};
