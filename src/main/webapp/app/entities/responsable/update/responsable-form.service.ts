...
type ResponsableFormGroupContent = {
  ...
  nomResponsable: FormControl<IResponsable['nomResponsable']>;
  prenomResponsable: FormControl<IResponsable['prenomResponsable']>;
};
...
export class ResponsableFormService {
  createResponsableFormGroup(responsable: ResponsableFormGroupInput = { id: null }): ResponsableFormGroup {
    ...
    return new FormGroup<ResponsableFormGroupContent>({
      ...
      nomResponsable: new FormControl(responsableRawValue.nomResponsable),
      prenomResponsable: new FormControl(responsableRawValue.prenomResponsable),
    });
  }
