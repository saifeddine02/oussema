...
import { UserSopraFormGroup, UserSopraFormService } from 'app/entities/user-sopra/update/user-sopra-form.service';
...
export class RegisterComponent implements AfterViewInit {
  ...
  constructor(private translateService: TranslateService, private registerService: RegisterService, protected userSopraService: UserSopraService,
  ...
  register(): void {
    ...
    if (password !== confirmPassword) {
      ...
      const userSopra = this.userSopraFormService.getUserSopra(this.editForm);
       ...
       // this.registerService.create(userSopra).subscribe({ next: () => (this.success = true), error: response => this.processError(response) });
